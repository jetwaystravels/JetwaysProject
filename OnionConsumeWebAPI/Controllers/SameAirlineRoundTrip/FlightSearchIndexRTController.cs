            ...
            else
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                   ...
                   // _SimpleAvailabilityobj.currentSourceOrganization = "";
                    ...
                    {
                        _IndigoAvailabilityResponseobj = await objgetAvail_.GetTripAvailabilitySameAirline(_GetfligthModel, _IndigologonResponseobj, TotalCount, adultcount, childcount, infantcount, flightclass, "SameIndigoRT");
                        count2 = 0;
                    ...
                    return RedirectToAction("RTFlightViewRT", "RoundTripRT");
                    //#endregion
                }
